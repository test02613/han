                  ...
                  <tr>
                     ...
                     <td style="width:60px;">
                      ...
                      <td style="text-align:center" >
                        <input type="text" value="${item.itemcolor}" style="width:80px; text-align:right; border:none;" readonly>
                        <input type="hidden" name="itemcode"  value="${item.itemcode}" style="width:80px; text-align:right; border:none;" readonly>
                     </td>
                     <td style="text-align:center">
                        <input type="text" name="ordercost" value="${item.itemcost}" style="width:80px; text-align:right; border:none;" readonly>원
                     </td>
                  </tr>
              </tbody>
            </table>
