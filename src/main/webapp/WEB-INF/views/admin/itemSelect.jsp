		...
		<h1>아이템</h1>
			<table class="table" >
				...
				<tbody>
					...
					<tr>
						<c:if test="${num==1 }"><tr onClick="location.href='/itemRegist?num=${list.itemnum}'"  style="cursor:pointer;"></c:if><!-- 상품수정 -->
						...
						<c:if test="${num==4 }"><tr onClick="location.href='/itemDeleteAction?num=${list.itemnum}'"  style="cursor:pointer;"></c:if><!-- 상품삭제 -->
