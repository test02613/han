			...
			<div class="boardWrite">
				<table border="1" summary="">
					...
					<tbody>
						...
						<tr>
							<th scope="row" class="uploadDiv2">상세 이미지 업로드</th>
							<td><input type="file" id="input_Detail_img"
								name="uploadDetailFile" style="height: 30px;" multiple />
								<button id="uploadBtn2">Upload</button></td>
						</tr>
						<tr>
							<th scope="row">상세 이미지 등록</th>
							<td><input type="text" id="itemDetailImg"
								name="itemDetailImg" style="height: 30px;"></td>
						<tr>
					</tbody>
				</table>
			</div>
