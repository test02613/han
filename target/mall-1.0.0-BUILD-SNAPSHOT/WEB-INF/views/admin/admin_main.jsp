				...
				<table border="1" summary="">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="file" id="itemImgupload" style="height: 30px;"></td>
 							<td><input type="button" class="itemImg_button"
								value="등록하기"></td> 
						</tr>
						<tr>
							<th scope="row">썸네일 이미지 등록</th>
							<td><input type="" id="itemImgupload" style="height: 30px;"></td>
						<tr>
							<th scope="row">상세 이미지 업로드</th>
							<td><input type="file" id="itemDetailImgupload" style="height: 30px;"></td>
							<td><input type="button" class="itemDetailImg_button" value="등록하기"></td>
						</tr>
					</tbody>
				</table>
			</div>
